...
var palettes = {
	...
	"2bit-demichrome":  PaletteShader.new_palette("#211e20,#555568,#a0a08b,#e9efec"),
	...
	"blk-aqu4":         PaletteShader.new_palette("#002b59,#005f8c,#00b9be,#9ff4e5"),
	...
	"gold-toad":        PaletteShader.new_palette("#283593,#00695c,#ffb74d,#fff59d"),
	...
	"ice-cream":        PaletteShader.new_palette("#7c3f58,#eb6b6f,#f9a875,#fff6d3"),
	...
	"warm-ochre":       PaletteShader.new_palette("#242021,#93722d,#cbae70,#eee6cf"),
...
func _ready():
	...
	palette_shader.set_palette(palettes.moonlight)
